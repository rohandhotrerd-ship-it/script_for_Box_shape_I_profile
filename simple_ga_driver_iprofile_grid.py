# -*- coding: utf-8 -*-
"""
simple_ga_driver_iprofile_grid.py

ONE-STAGE GA driver for the fixed row-column I-profile stiffener model.
...
from evaluate_design_iprofile_grid import evaluate_design
...
RESULTS_DIR = r"C:\Rhino Hiwi\Thesis\cad_to_stp\BoxShape_Iprofile\iprofile_grid_one_stage_scripts\Iprofile_grid_GA_result"
...
CSV_LOG = os.path.join(RESULTS_DIR, "ga_master_log_iprofile_grid_%s.csv" % time.strftime("%Y%m%d_%H%M%S"))
BEST_JSON = os.path.join(WORK_DIR, "best_design_iprofile_grid.json")
...
def ensure_csv_header():
    ...
    with open(CSV_LOG, "w", newline="") as f:
        ...
        w.writerow([
            ...
            "Height", "Width", "Thickness_skin", "Thickness_stiff", "stud_max",
...
def run_ga():
    print("\n" + "#" * 100)
    print("ONE-STAGE I-PROFILE GRID GA")
    print("#" * 100)
