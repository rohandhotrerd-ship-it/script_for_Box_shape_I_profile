...
# ------------------------------------------------------------
EDGE_SIZE_SFULL     = 4.0
EDGE_SIZE_SHALF_WEB = 4.0
EDGE_SIZE_PATCHES   = 4.0
...
# Ensure parts exist
for pn in (PART_SFULL, PART_SHALF_WEB, PART_PATCHES, PART_LOWSKIN):
...
p_shalf   = mdb_model.parts[PART_SHALF_WEB]
p_patch   = mdb_model.parts[PART_PATCHES]
