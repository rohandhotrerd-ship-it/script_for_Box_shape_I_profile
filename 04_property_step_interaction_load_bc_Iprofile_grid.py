...
# Parts
PARTS = ["S_full", "S_half_web", "Patches", "Lower_Skin"]
...
# Tie interactions
TIES = [
    ("Lower_skin_Low_Patches",
     (INST_PATCHES, "SURF_LOWER_PATCHES_SNEG"),
    ...
    ("Sfull_Patches",
     ("ASM", "SURF_EDGES__SET_PATCHES_SFULL_IFACE_EDGES"),
     ("ASM", "SURF_EDGES__SET_SFULL_PATCH_IFACE_EDGES")),

    ("Sfull_Shalf",
     ("ASM", "SURF_EDGES__SET_SFULL_WEB_END_EDGES"),
     (INST_SHALF_WEB, "SURF_SHALF_WEB_MESH")),

    ("Shalf_LowPatches",
     ("ASM", "SURF_EDGES__SET_SHALF_WEB_BOTTOM_EDGES"),
     (INST_PATCHES, "SURF_LOWER_PATCHES_SPOS")),

    ("Shalf_TopPatches",
     ("ASM", "SURF_EDGES__SET_SHALF_WEB_TOP_EDGES"),
     (INST_PATCHES, "SURF_UPPER_PATCHES_SNEG")),
]
# ============================================================
...
def prepare_base_model():
    ...
    _require(INST_PATCHES in asm.instances.keys(),
             "Missing instance: %s (run import+assemble first)" % INST_PATCHES)
